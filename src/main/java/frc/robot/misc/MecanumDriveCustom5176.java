 ...
 */
public class MecanumDriveCustom5176 extends RobotDriveBase {
   ...
   */
  public MecanumDriveCustom5176(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
  ...
  public void driveCartesian(double ySpeed, double xSpeed, double zRotation, double gyroAngle) {
    ...
    m_frontLeftMotor.set(wheelSpeeds[MotorType.kFrontLeft.value] * m_maxOutput * RobotMap.MECANUM_FRONT_LEFT_MULTIPLIER);
    m_frontRightMotor.set(wheelSpeeds[MotorType.kFrontRight.value] * m_maxOutput
        * m_rightSideInvertMultiplier * RobotMap.MECANUM_FRONT_RIGHT_MULTIPLIER);
    m_rearLeftMotor.set(wheelSpeeds[MotorType.kRearLeft.value] * m_maxOutput * RobotMap.MECANUM_REAR_LEFT_MULTIPLIER);
    m_rearRightMotor.set(wheelSpeeds[MotorType.kRearRight.value] * m_maxOutput
        * m_rightSideInvertMultiplier * RobotMap.MECANUM_REAR_RIGHT_MULTIPLIER);
  ...
  // custom method to set front motors
  public void setFrontMotorsOnly(double speed) {
    ...
    m_frontLeftMotor.set(-speed * RobotMap.MECANUM_FRONT_LEFT_MULTIPLIER);
    m_frontRightMotor.set(-speed * RobotMap.MECANUM_FRONT_RIGHT_MULTIPLIER * m_rightSideInvertMultiplier);
  }
}